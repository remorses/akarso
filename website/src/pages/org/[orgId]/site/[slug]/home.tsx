...
import { BlockWithStep } from 'website/../beskar/dashboard'
    ...
    return (
        <DashboardContainer sites={sites}>
            <div className='flex self-stretch w-full gap-12'>
                <div className='grow flex flex-col gap-1 max-w-[50%]'>
                    <BlockWithStep step={1}>
                        <div className=''>
                            When the user wants to connect SSO, redirect him to
                            the Akarso Admin Portal
                        </div>
                        <Code
                            language='js'
                            className='text-sm'
                    ...
                    <BlockWithStep step={2}>
                        <div className=''>
                            In your callback page, connect the SSO connection to
                            your team entity
                        </div>
                        <Code
                            language='js'
