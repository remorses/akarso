...
import { setServerConfig, getServerConfig, deleteServerConfig, resolveBaseUrl, createClient, } from "../client.js";
...
async function exchangeTokenForApiKey({ accessToken, websiteUrl, fs, env, console, }) {
...
auth
    ...
    try {
        ...
        console.error(`API key validation failed: ${err instanceof Error ? err.message : String(err)}`);
        process.exit(1);
    }
});
auth
    .command('auth logout', dedent `
